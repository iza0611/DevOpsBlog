...
export default function SinglePost() {
  ...
  const handleDelete = async () => {
    try {
      await axios.delete(
        `http://ec2-52-23-253-217.compute-1.amazonaws.com:5000/api/posts/${post._id}`,
        {
          ...
          <h1 className="singleTitle">
            ...
            {post.username === user?.username && (
              <div className="action">
                <i
                  className="singleIcon fa fa-edit"
                  onClick={() => setUpdateMode(true)}
                ></i>
                <i
                  className="singleIcon fa fa-trash-alt"
